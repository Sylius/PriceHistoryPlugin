...
use Sylius\PriceHistoryPlugin\Application\Message\ExcludeTaxonFromShowingLowestPrice;
use Sylius\PriceHistoryPlugin\Domain\Model\ChannelInterface;
use Symfony\Component\Messenger\Handler\MessageHandlerInterface;

final class ExcludeTaxonFromShowingLowestPriceHandlerSpec extends ObjectBehavior
{
    ...
    function it_throws_exception_when_channel_cannot_be_found(
        ...
        $this->shouldThrow(\InvalidArgumentException::class)->during('__invoke', [
            ExcludeTaxonFromShowingLowestPrice::createFromData('WEB', 'T_SHIRTS'),
        ]);
    }
    ...
    function it_excludes_a_taxon_from_showing_lowest_price_in_channel(
        ...
        $channel->addTaxonExcludedFromShowingLowestPrice($taxon)->shouldBeCalled();

        $this->__invoke(ExcludeTaxonFromShowingLowestPrice::createFromData('WEB', 'T_SHIRTS'));
    }
}
