...
Feature: Seeing the correct product's lowest price according to the period set on the channel
    ...
    Background:
        ...
        And on "2023-01-05" its price changed to "$11.00"
        And on "2023-01-15" its price changed to "$13.00" and original price to "$10.00"
        And on "2023-01-25" its price changed to "$15.00" and original price to "$5.00"
    ...
    Scenario: Seeing the correct lowest price from 30 days before the discount
        ...
        Then I should see "$10.00" as this product's lowest price from before the discount
    ...
    Scenario: Seeing the correct lowest price from 10 days before the discount
        ...
        When I check this product's details
        Then I should see "$11.00" as this product's lowest price from before the discount
    ...
    Scenario: Seeing the correct lowest price from 1 day before the discount
        ...
        When I check this product's details
        Then I should see "$13.00" as this product's lowest price from before the discount
