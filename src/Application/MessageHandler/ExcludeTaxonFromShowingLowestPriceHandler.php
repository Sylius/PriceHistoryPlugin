...
final class ExcludeTaxonFromShowingLowestPriceHandler implements MessageHandlerInterface
{
    ...
    public function __invoke(ExcludeTaxonFromShowingLowestPrice $command): ChannelInterface
    {
